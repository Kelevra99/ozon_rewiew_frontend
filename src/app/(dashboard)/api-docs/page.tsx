  ...
  "billing": {
    ...
    "balanceAfterMinor": 15316
      ...
      <Section title="6. Передача результата обработки">
        <p>
          Если после генерации ваша система сама вставляет ответ, публикует его или хочет
          зафиксировать финальный результат, можно передать статус обратно:
        </p>
...
canceled`}</CodeBlock>
      ...
      <Section title="7. Типовой сценарий интеграции">
        ...
        <p>4. Получаете готовый текст ответа, токены и стоимость в рублях.</p>
