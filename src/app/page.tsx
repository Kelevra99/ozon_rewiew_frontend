...
const comparisonExamples: ComparisonExample[] = [
  {
    ...
    fineroxReply:
      'Здорово, что мультитул KaiRox так понравился и подошёл в деле. И да, вы верно подметили момент со «звёздочками» — в комплект к KR30 мы специально кладём два ключа Torx, чтобы при необходимости можно было в любой момент чуть подтянуть и подстроить механику под себя. Пусть муж пользуется с удовольствием — KR30 как раз и задуман как рабочий универсал на каждый день.',
    marketplaceWeaknesses: [
      'Сухой и затянутый тон',
      'Перепутана модель: KR301 вместо KR30',
  ...
  },
  {
    ...
    review:
      'Отзыв не знаю под какой мультитул, но под лезерман сурж, придётся доработать напильником.',
    marketplaceReply:
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/10 backdrop-blur">
            ...
            <div className="mt-5 space-y-4 text-sm leading-7 text-slate-300">
              <div className="rounded-2xl border border-white/10 bg-slate-950/30 px-4 py-3">
                Ручной режим через расширение — можно начать без доступа к
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-950/30 px-4 py-3">
                API-сценарий — когда вам уже подходит более глубокая
                автоматизация и есть доступ к отзывам через маркетплейс.
              </div>
            ...
            <div className="mt-6 rounded-2xl border border-amber-300/20 bg-amber-300/10 p-4">
              ...
              <div className="mt-2 text-sm leading-6 text-slate-200">
                Для ручного режима нам не нужен доступ к вашему кабинету, не
                нужно создавать менеджера и не нужно выдавать лишние права.
                Сначала вы спокойно смотрите, как сервис отвечает, и только
                потом решаете, нужен ли вам следующий уровень автоматизации.
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/10 backdrop-blur">
            <div className="max-w-4xl">
              ...
              <p className="mt-3 text-base leading-7 text-slate-300">
                ...
                отзыв: слева — типичный платный шаблонный ответ, справа — ответ
                Finerox с учётом смысла отзыва, особенностей товара и нормального
                человеческого тона.
              </p>
            </div>
        ...
        <div className="rounded-3xl border border-amber-300/20 bg-gradient-to-r from-amber-100 via-amber-200 to-orange-200 p-8 text-slate-950 shadow-[0_8px_24px_rgba(251,191,36,0.18)]">
          <div className="max-w-4xl">
            ...
            <p className="mt-4 text-base leading-7 text-slate-800">
              Не нужно покупать подписку ради теста. Пополните баланс, проверьте
              ручной режим, настройте правила и только потом решайте, хотите ли
              вы переходить к полной автоматизации.
            </p>
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/10 backdrop-blur">
      ...
      <div className="mt-5 grid gap-4 xl:grid-cols-2">
        <ResponseCard
          tone="marketplace"
          title="Типичный платный генератор"
