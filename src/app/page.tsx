...
const stats = [
  {
    label: 'ЛЕГКИЙ СТАРТ',
    value: 'от 10 ₽',
    hint: 'Пополните баланс на минимальную сумму и проверьте сервис на практике без подписки и лишних обязательств.',
  },
  {
    label: 'СРЕДНЯЯ ЦЕНА',
    value: '≈ от 30 ₽ за 100 ответов',
  ...
  },
  {
    ...
    hint: 'Работаем с юрлицами и ИП, принимаем безналичную оплату и предоставляем закрывающие документы.',
  },
  {
    label: 'API-ИНТЕГРАЦИЯ',
    value: 'Сайт, CRM, 1С',
    hint: 'Сервис можно встроить в сайт, CRM или 1С. Если у площадки есть API отзывов, доступна автоматическая обработка.',
  },
];
