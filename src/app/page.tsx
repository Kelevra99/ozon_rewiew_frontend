...
const comparePoints = [
  ...
  },
  {
    ...
    text:
      'Ручной и автоматический режим через расширение позволяют начать без доступа к кабинету, без передачи учётных данных и без сложной интеграции. Вы сначала смотрите качество ответов, а уже потом решаете, нужен ли вам API-сценарий.',
  },
];
