...
const stats = [
  {
    label: 'Быстрый старт',
    value: 'от 10 ₽',
    hint: 'Можно пополнить баланс на небольшую сумму, проверить качество ответов и спокойно оценить сервис на практике.',
  },
  {
    label: 'Средняя цена',
    value: '≈ 30 ₽ / 100 ответов',
    hint: 'При стандартной настройке контекста и правил ответы обходятся недорого даже при регулярной работе.',
  },
  {
    label: 'Юрлица и ИП',
  ...
  },
  {
    ...
    value: 'по правилам',
    hint: 'Автоматизация там, где площадка открывает нужный API-доступ и разрешает работу с отзывами.',
  },
];
...
const faq = [
  {
    ...
    a: 'Нет. Для работы доступ к магазину не нужен. Вы можете генерировать ответы вручную или создать API-доступ только для работы с отзывами. Другие доступы нам не нужны, отдельного менеджера в кабинете создавать тоже не требуется.',
  },
  {
  ...
  },
  {
    ...
    a: 'Стоимость зависит от того, сколько текста вы передаёте в обработку, какие настройки используете и какая модель ИИ выбрана. В среднем при правильной настройке даже сильная модель может генерировать ответ примерно за 1 ₽. В ряде случаев стоимость можно снизить до 80 копеек, если сократить промты, а можно поднять и до 2 ₽ за обработку, если задать большой и подробный сценарий. Всё это регулируется тремя уровнями настроек: общий тон ответов, правила магазина и отдельные инструкции по каждому товару. Дополнительно можно передавать краткую информацию о товаре, чтобы ИИ лучше понимал его характеристики и давал более точные ответы.',
  },
  {
        ...
        <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_420px]">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/10 backdrop-blur">
            ...
            <div className="mt-5 space-y-4 text-sm leading-7 text-slate-300">
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-950/30 px-4 py-3">
                Автоматизация по API — там, где площадка позволяет
