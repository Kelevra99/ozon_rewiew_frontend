  ...
  export default function ListPage() {
    ...
    async function load() {
      ...
      setErrorText('');
      try {
        const result = await apiFetch('/admin/reviews', {
          method: 'GET',
          auth: true,
        });
        setData(result);
  ...
  .filter(Boolean);
    ...
    return (
      <div className="space-y-6">
        <PageHeader
          title="Admin: генерации"
          description="GET /v1/admin/reviews. Общий список генераций."
        ...
        {rows.length ? (
          <Card>
            <DataTable rows={rows} preferredColumns={["id", "status", "productName", "rating", "marketplace", "createdAt"]} />
